...
*/
class UserService : public Wuser::UserServiceRpc // 继承自 protobuf 生成的 RPC 服务基类
{
public:
    // 本地登录方法，用于处理实际的业务逻辑
    ...
    */
    void Login(::google::protobuf::RpcController* controller,
              const ::Wuser::LoginRequest* request,
              ::Wuser::LoginResponse* response,
        ...
        // 将响应结果写入 response 对象
        Wuser::ResultCode *code = response->mutable_result();
